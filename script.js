...
const items = {
    ...
    108: {type: "xray", x: 4729, y: 1974, area: "brinstar", name: "X-Ray Scope", jpName: "Xレイスコープ", order100Percent: 22},
    ...
    // Missiles (301-346)
    301: {type: "missile", x: 100, y: 100, area: "crateria", name: "Missile Tank", jpName: "ミサイルタンク", order100Percent: 1},
    302: {type: "missile", x: 200, y: 200, area: "crateria", name: "Missile Tank", jpName: "ミサイルタンク", order100Percent: 2},
    303: {type: "missile", x: 300, y: 300, area: "crateria", name: "Missile Tank", jpName: "ミサイルタンク", order100Percent: 3},
    304: {type: "missile", x: 400, y: 400, area: "crateria", name: "Missile Tank", jpName: "ミサイルタンク", order100Percent: 4},
    305: {type: "missile", x: 500, y: 500, area: "crateria", name: "Missile Tank", jpName: "ミサイルタンク", order100Percent: 5},
    306: {type: "missile", x: 600, y: 600, area: "crateria", name: "Missile Tank", jpName: "ミサイルタンク", order100Percent: 6},
    307: {type: "missile", x: 700, y: 700, area: "crateria", name: "Missile Tank", jpName: "ミサイルタンク", order100Percent: 7},
    308: {type: "missile", x: 800, y: 800, area: "crateria", name: "Missile Tank", jpName: "ミサイルタンク", order100Percent: 8},
    309: {type: "missile", x: 900, y: 900, area: "crateria", name: "Missile Tank", jpName: "ミサイルタンク", order100Percent: 9},
    310: {type: "missile", x: 1000, y: 1000, area: "crateria", name: "Missile Tank", jpName: "ミサイルタンク", order100Percent: 10},
    311: {type: "missile", x: 1100, y: 1100, area: "crateria", name: "Missile Tank", jpName: "ミサイルタンク", order100Percent: 11},
    312: {type: "missile", x: 1200, y: 1200, area: "crateria", name: "Missile Tank", jpName: "ミサイルタンク", order100Percent: 12},
    313: {type: "missile", x: 1300, y: 1300, area: "crateria", name: "Missile Tank", jpName: "ミサイルタンク", order100Percent: 13},
    314: {type: "missile", x: 1400, y: 1400, area: "crateria", name: "Missile Tank", jpName: "ミサイルタンク", order100Percent: 14},
    315: {type: "missile", x: 1500, y: 1500, area: "crateria", name: "Missile Tank", jpName: "ミサイルタンク", order100Percent: 15},
    316: {type: "missile", x: 1600, y: 1600, area: "crateria", name: "Missile Tank", jpName: "ミサイルタンク", order100Percent: 16},
    317: {type: "missile", x: 1700, y: 1700, area: "crateria", name: "Missile Tank", jpName: "ミサイルタンク", order100Percent: 17},
    318: {type: "missile", x: 1800, y: 1800, area: "crateria", name: "Missile Tank", jpName: "ミサイルタンク", order100Percent: 18},
    319: {type: "missile", x: 1900, y: 1900, area: "crateria", name: "Missile Tank", jpName: "ミサイルタンク", order100Percent: 19},
    320: {type: "missile", x: 2000, y: 2000, area: "crateria", name: "Missile Tank", jpName: "ミサイルタンク", order100Percent: 20},

    // Super Missiles (401-410)
    401: {type: "super_missile", x: 100, y: 100, area: "crateria", name: "Super Missile Tank", jpName: "スーパーミサイルタンク", order100Percent: 1},
    402: {type: "super_missile", x: 200, y: 200, area: "crateria", name: "Super Missile Tank", jpName: "スーパーミサイルタンク", order100Percent: 2},
    403: {type: "super_missile", x: 300, y: 300, area: "crateria", name: "Super Missile Tank", jpName: "スーパーミサイルタンク", order100Percent: 3},
    404: {type: "super_missile", x: 400, y: 400, area: "crateria", name: "Super Missile Tank", jpName: "スーパーミサイルタンク", order100Percent: 4},
    405: {type: "super_missile", x: 500, y: 500, area: "crateria", name: "Super Missile Tank", jpName: "スーパーミサイルタンク", order100Percent: 5},
    406: {type: "super_missile", x: 600, y: 600, area: "crateria", name: "Super Missile Tank", jpName: "スーパーミサイルタンク", order100Percent: 6},
    407: {type: "super_missile", x: 700, y: 700, area: "crateria", name: "Super Missile Tank", jpName: "スーパーミサイルタンク", order100Percent: 7},
    408: {type: "super_missile", x: 800, y: 800, area: "crateria", name: "Super Missile Tank", jpName: "スーパーミサイルタンク", order100Percent: 8},
    409: {type: "super_missile", x: 900, y: 900, area: "crateria", name: "Super Missile Tank", jpName: "スーパーミサイルタンク", order100Percent: 9},
    410: {type: "super_missile", x: 1000, y: 1000, area: "crateria", name: "Super Missile Tank", jpName: "スーパーミサイルタンク", order100Percent: 10},

    // Power Bombs (501-510)
    501: {type: "power_bomb", x: 100, y: 100, area: "crateria", name: "Power Bomb Tank", jpName: "パワーボムタンク", order100Percent: 1},
    502: {type: "power_bomb", x: 200, y: 200, area: "crateria", name: "Power Bomb Tank", jpName: "パワーボムタンク", order100Percent: 2},
    503: {type: "power_bomb", x: 300, y: 300, area: "crateria", name: "Power Bomb Tank", jpName: "パワーボムタンク", order100Percent: 3},
    504: {type: "power_bomb", x: 400, y: 400, area: "crateria", name: "Power Bomb Tank", jpName: "パワーボムタンク", order100Percent: 4},
    505: {type: "power_bomb", x: 500, y: 500, area: "crateria", name: "Power Bomb Tank", jpName: "パワーボムタンク", order100Percent: 5},
    506: {type: "power_bomb", x: 600, y: 600, area: "crateria", name: "Power Bomb Tank", jpName: "パワーボムタンク", order100Percent: 6},
    507: {type: "power_bomb", x: 700, y: 700, area: "crateria", name: "Power Bomb Tank", jpName: "パワーボムタンク", order100Percent: 7},
    508: {type: "power_bomb", x: 800, y: 800, area: "crateria", name: "Power Bomb Tank", jpName: "パワーボムタンク", order100Percent: 8},
    509: {type: "power_bomb", x: 900, y: 900, area: "crateria", name: "Power Bomb Tank", jpName: "パワーボムタンク", order100Percent: 9},
    510: {type: "power_bomb", x: 1000, y: 1000, area: "crateria", name: "Power Bomb Tank", jpName: "パワーボムタンク", order100Percent: 10}
};
...
// Toggle item collection state
    function toggleItem(id) {
        const index = id - 1;
        collectedItems[index] = !collectedItems[index];

        // Update UI
        $(`.item-entry[data-id="${id}"]`).toggleClass('collected', collectedItems[index]);
        $(`.item-marker[data-id="${id}"]`).toggleClass('collected', collectedItems[index]);
